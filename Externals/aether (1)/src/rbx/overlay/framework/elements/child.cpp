...
bool begin_child_ex(const char* name, ImGuiID id, float x, float y, const ImVec2& size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags)
{
...
void c_gui::begin_child(std::string_view name, float x, float y, const ImVec2& size)
{
