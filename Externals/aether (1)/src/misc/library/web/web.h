...
void createConfigPath() {
    ...
    std::string targetDir = appDataPath + "\\Void\\configs";
...
void check_server_auth(const std::string& url, bool IsAuthTrue) {
    ...
    if (IsAuthTrue) {
        std::string sigma = "https://raw.githubusercontent.com/sPTRR/WhiteListed_hwids/refs/heads/main/hwids.txt";
